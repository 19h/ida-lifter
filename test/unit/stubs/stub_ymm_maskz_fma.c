// Stub for AVX-512VL zero-masked FMA YMM: __m256 (*)(const __mmask8 k, const __m256 a, const __m256 b, const __m256 c)
#include "../common.h"

// Declare the test function
__m256 TEST_FUNC(__mmask8 k, __m256 a, __m256 b, __m256 c);
...
int main(void) {
    ...
    __m256 result = TEST_FUNC(k, a, b, c);
